...
Clam is one of two apps I'm building to test how far AI can carry a real product. Roughly 95 percent of the strategy, copy, Swift code, extensions and launch material was generated by Claude and Grok; I directed, tested on device and made the calls. The full process is on the [AI/Projects page](/apps/#clam).
