...
export const projects: Project[] = [
  ...
  },
  {
    ...
    fg: '#7de8b8',
    hero: {
      title: 'Drink less. Not never.',
      sub: 'Damp is a dry days tracker for people who want to cut back without quitting. A nine o’clock check-in, one tap from the notification, and a running count of dry nights, money kept and calories skipped. No account, no coach, no judgment.',
      screen: 'image',
      image: '/showcase/damp-home.jpg',
    },
    siteShot: {
      desktop: '/showcase/damp-site.jpg',
      mobile: '/showcase/damp-site-mobile.jpg',
      caption: 'usedamp.app, live: landing page, a drinking cost calculator, guides on damp drinking and Dry January, support, privacy and terms. Served from GitHub Pages.',
      url: 'https://usedamp.app',
    },
    features: [
      {
        eyebrow: 'The reveal',
        title: 'Your number, in your money.',
        body: 'Onboarding asks how many drinks a week and what one costs, then shows the year: what you spend, what that is in days of food, and what four dry nights a week gives back. It is the screen people screenshot, and it comes before the paywall.',
        screen: 'image',
        image: '/showcase/damp-reveal.jpg',
      },
      {
        eyebrow: 'Milestones',
        title: 'A card worth posting.',
        body: 'Streaks of 1, 3, 7, 14, 30, 60, 100 and 365 dry nights each get a share card. A drinking night is a number, not a failure: the streak resets, the savings and the history stay.',
        screen: 'image',
        image: '/showcase/damp-milestone.jpg',
        flip: true,
      },
    ],
    split: {
      ...
      aiLabel: 'Claude Code',
      meLabel: 'Nick',
      aiDid: 'Picked the category from the same playbook as Clam, wrote the strategy and naming notes, the nine onboarding screens, the SwiftUI app and widget, StoreKit 2 paywall, unit tests, CI, the landing site with its guides and support page, and the launch kit.',
      meDid: 'Kept the name when the first domains were taken, chose usedamp.app, set one price across every app, asked for support and feedback options, ran the DNS setup and made every yes or no along the way.',
    },
    steps: [
      { title: 'Pick the idea', ai: 'Ran the playbook: a daily felt problem, proven spend, a seven-second demo, no backend. Chose drinking less over quitting.', me: '“Follow the same process we did for Clam, but make an entirely new app idea.”' },
      { title: 'Name it twice', ai: 'Proposed Damp, tried a rename when asked, then checked domain registries and found usedamp.app free.', me: '“I like Damp a lot but domains were taken.”' },
      { title: 'Build and check', ai: 'Generated the app, widget and tests, captured every screen in the simulator and walked the onboarding end to end.', me: 'Reviewed the screens and the site, changed the prices.' },
      { title: 'Put it live', ai: 'Created the repo, turned on Pages, wrote a setup script that reads the Cloudflare token from the clipboard, enforced HTTPS.', me: 'Bought the domain, made the token, clicked Run.' },
    ],
    links: [
      { label: 'usedamp.app', href: 'https://usedamp.app', primary: true },
      { label: 'Source on GitHub', href: 'https://github.com/nickstrom5/damp' },
    ],
    status: 'In development · App Store link goes live with the listing',
    caseStudy: 'damp-drink-less-tracker',
  },
  {
    id: 'launchneat',
    name: 'LaunchNeat',
  ...
  },
  {
    ...
    split: {
      ...
      meDid: 'The brief: a client-facing proof of GTM engineering, not a résumé site. The order of the five systems, the name, the domain, and a review of every demo before merge.',
    },
    steps: [
      { title: 'Read the brief', ai: 'Turned the prompt into a plan: five demos in pipeline order, a prompt lab, the commercial foundation, one Next.js app deployable in one command.', me: '“A client-facing proof artifact, not a résumé site.”' },
