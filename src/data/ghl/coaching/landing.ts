...
export const landing: LandingPage = {
  ...
  consent: {
    transactional: 'Text me workshop reminders from Trailhead Career Coaching. Up to 4 messages per workshop. Msg & data rates may apply. Reply HELP for help, STOP to opt out.',
  ...
  steps: [
    ...
    'Form Submitted fires workflow 01 · Workshop Registration, which sets the workshop date with Event Start Date.',
  ...
  notes: [
    ...
    { title: 'Phone optional, texts opt-in', body: 'Email is required, the phone is not. The text box is unticked and optional and says how many messages to expect, and ticking it without a number asks for one.' },
