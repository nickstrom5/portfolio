...
export const inspectionBooked: Automation = {
  ...
  scenarios: [
    ...
    },
    {
      ...
      summary: 'Phoned in and was booked on the spot, so there is no opportunity. The workflow makes one at Inspection Booked, then runs as normal and finds it again before moving it to Inspected.',
      start: DAY + 11 * 60 + 15,
      trigger: 1,
      ...
      expect: { outcome: 'goal', visits: ['find-opp:else', 'create-opp', 'goto-confirm', 'email-confirm', 'if-showed:0', 'find-inspected:0', 'opp-inspected', 'whose-estimate:0', 'task-estimate-luis'], stage: 'Inspected' },
    },
    {
      id: 'no-show',
      label: 'Nobody home',
